...
def _get_or_default(cfg_obj: Dict[str, Optional[str]], key: str, default: Any = None, conv: Optional[Callable[[str], Any]] = None) -> Any:
...
class ColumnConfig(object):
    ...
    def __init__(self, name: str, label: Optional[str] = None, alt_y_axis: bool = False):
        self.name = name
